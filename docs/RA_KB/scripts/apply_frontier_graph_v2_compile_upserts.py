#!/usr/bin/env python3
"""Apply Frontier/Graph Bridge v2 compile-confirmation upserts to RAKB v0.5 registry."""
...
def main() -> None:
    ...
    patch_dir = args.packet_root / "registry_upserts_frontier_graph_v2"
    upsert_csv(
        args.registry / "artifacts.csv",
        patch_dir / "RAKB_frontier_graph_v2_artifacts_upsert_compile_confirmed_Apr29_2026.csv",
        ["artifact_id"],
        args.dry_run,
    )
    upsert_csv(
        args.registry / "claim_artifact_edges.csv",
        patch_dir / "RAKB_frontier_graph_v2_claim_artifact_edges_upsert_compile_confirmed_Apr29_2026.csv",
    ...
    copy_report(
        args.packet_root / "reports" / "RA_FrontierGraphBridge_CompileConfirmed_Report_Apr29_2026.md",
        dest,
        args.dry_run,
    )
