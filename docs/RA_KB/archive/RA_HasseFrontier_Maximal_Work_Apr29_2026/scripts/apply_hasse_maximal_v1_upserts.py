#!/usr/bin/env python3
"""Apply RA_HasseFrontier_Maximal_v1 upserts to RAKB v0.5 registry."""
...
def main() -> None:
    ...
    patch_dir = args.packet_root / "registry_upserts_hasse_maximal_v1"
    upsert_csv(
        args.registry / "artifacts.csv",
        patch_dir / "RAKB_hasse_maximal_v1_artifacts_upsert_Apr29_2026.csv",
        ["artifact_id"],
        args.dry_run,
    )
    upsert_csv(
        args.registry / "claim_artifact_edges.csv",
        patch_dir / "RAKB_hasse_maximal_v1_claim_artifact_edges_upsert_Apr29_2026.csv",
        ["claim_id", "artifact_id", "relation", "source_span"],
        args.dry_run,
    )

    dest = args.reports / "selector_closure_Apr29_2026"
    copy_report(args.packet_root / "formalization_notes" / "RA_HasseFrontier_Maximal_Programme_Apr29_2026.md", dest, args.dry_run)
    copy_report(args.packet_root / "reports" / "RA_HasseFrontier_Maximal_First_Formalization_Report_Apr29_2026.md", dest, args.dry_run)
