...
\texttt{RA\_AQFT\_Proofs\_v10.lean}. The Graph Cut
...
\midrule
LLC (Definition~\ref{def:LLC}) & \texttt{RA\_D1\_Proofs.lean} & Lean-proved, 0 sorry \\
Graph Cut Theorem & \texttt{RA\_D1\_Proofs.lean} & Lean-proved, 0 sorry \\
...
The combined RA Lean~4 corpus contains \textbf{93 fully sorry-free results}
across \texttt{RA\_D1\_Proofs.lean} (73 results) and
\texttt{RA\_Alpha\_EM\_Proof.lean} (20 results), with zero \texttt{sorry}
tags in either file.
\texttt{RA\_AQFT\_Proofs\_v10.lean} compiles in Lean~4.29.0 with one
intentional placeholder (\texttt{Matrix.cfc\_conj\_unitary}, pending the
Lean-QuantumInfo library adapter); all other results including
\texttt{frame\_independence} and \texttt{rindler\_stationarity}
are fully proved with zero sorry tags.
