...
derivation targets are tabulated. The programme comprises eleven papers;
two are in peer review (\emph{Foundations of Physics}; \emph{Classical
and Quantum Gravity}).
...
\begin{itemize}[noitemsep]
  \item Two papers in peer review: RAQM at \emph{Foundations of Physics}
  (past desk rejection, in editor assignment); RACL submitted to
  \emph{Classical and Quantum Gravity}.
  \item Eleven companion papers on Zenodo with permanent DOIs.
