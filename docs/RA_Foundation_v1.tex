...
Lean~4 proof files establish \textbf{93 results} with zero \texttt{sorry}
...
fragility (electrons at minimum BDG score~1).
\end{abstract}
...
\begin{enumerate}[noitemsep,label=\arabic*.,leftmargin=*]
  ...
  \item \textbf{EB}~\citep{Sandeman2026RAEB} --- The Engine of Becoming;
