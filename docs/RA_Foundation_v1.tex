...
The observed dark matter phenomenology is explained differently: in the
sparse galactic halo regime ($\mu < 1$), the causal graph is locally
2-dimensional by the Durhuus-Jonsson-Wheater theorem for directed
Lorentzian graphs. The $1/r^2$ gravitational law becomes $1/r$ in 2D,
giving flat rotation curves. Causal flux conservation on a 2D graph
gives the baryonic Tully-Fisher relation
$v_{\mathrm{flat}}^4 = a_0\,G\,M$ exactly, with $a_0$ identified as
the shadow of the critical density $\lambda_c$ where $\mu = 1$, the
Erd\H{o}s-R\'{e}nyi percolation
threshold~\citep{Sandeman2026RADM}.
...
No dark matter below neutrino floor & WIMP prohibited structurally & Ongoing \\
...
Wyler $\alpha = 9/(8\pi^4)(\pi^5/1920)^{1/4}$ & Conjecture (0.00006\%) & RASM Conj.~7.2 \\
...
\paragraph{The Wyler formula for $\alpha_{\mathrm{EM}}$ (conjecture).}
The fine structure constant satisfies the empirical Wyler
formula~\citep{Wyler1969} $\alpha = 9/(8\pi^4)(\pi^5/1920)^{1/4}$
to $0.00006\%$ with no free parameters. In RA the structural form is
$\alpha = N^2/(2^{d-1}\pi^d)(\pi^{d+1}/2^d\,(d{+}1)!)^{1/4}$, where $N = 3$
(BDG non-gravitational DOFs) and $d = 4$ are both derived from the BDG
topology. The factor $2^{d-1} = 8$ is identically the coefficient in the
quark Koide correction $8\alpha/\pi$ and in the Wyler denominator. The
three quantities --- quark Koide breaking, the Wyler formula, and the
BDG dimension factor --- share the same structural origin. A derivation
from BDG causal-diamond volumes is an open target (RASM Conjecture~7.2).
