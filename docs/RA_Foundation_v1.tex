...
notebook confirms 52/52 numerical checks at machine precision, and a
Lean~4 proof file establishes 21 theorems with no axioms, including
the Koide $K = 2/3$ identity for all $m_0 > 0$ and $\theta \in \mathbb{R}$,
the Majorana Koide identity, and the $SU(3)_{\mathrm{gen}}$ roots-of-unity
sum identities.
\end{abstract}
...
\begin{enumerate}[noitemsep,label=\arabic*.,leftmargin=*]
  ...
  \item \textbf{EB}~\citep{Sandeman2026EB} --- The Engine of Becoming;
...
the Covariant Stochastic Graph Rewriting System (CSG)~\citep{Sandeman2026EB}
...
Two $\sim$50-line Lean~4 targets: (a) the chirality theorem
