...
lensing profile with Einstein radius $\theta_E = 0.93$~arcsec, consistent with
observations. Furthermore, we formalise the distinction between
...
Poisson-CSG generative measure established in RAGC,
...
This is mathematically equivalent to a Singular Isothermal Sphere (SIS)
within the baryon distribution, giving:
\begin{equation}
  \kappa_{\mathrm{RA}}(b) = \frac{v_{\mathrm{flat}}^2}{2\pi G\,\Sigma_{\mathrm{cr}}\,b},
  \qquad
  \theta_E = \frac{4\pi v_{\mathrm{flat}}^2}{c^2}\frac{D_{LS}}{D_S}.
  \label{eq:SIS_kappa}
\end{equation}
