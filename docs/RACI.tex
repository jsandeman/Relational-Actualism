...
\paragraph{The dynamical reinforcement.}
The structural impossibility is reinforced by a dynamical mechanism: the
dual severance process (RAGC~\S6.6) fragments every causally connected
component on a finite timescale via starvation severance (voids) and
density severance (filament boundaries). No causal patch persists long
enough for BB nucleation even if the structural argument were relaxed.
The combination is doubly categorical.
