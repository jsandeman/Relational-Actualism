...
paper RACL via Lovelock's theorem,
the Lean-verified LLC, and the $\mathcal{P}_{\mathrm{act}}$ conservation theorem. The foliation-independence of the quantum measure
...
\texttt{RA\_AQFT\_Proofs\_v10.lean} (theorem \texttt{causal\_invariance},
zero sorry tags). The remaining open problem is proving amplitude locality
intrinsically on the discrete graph (Hard Wall~1).
