...
\centering
\vspace*{1cm}
{\LARGE\bfseries Relational Actualism: Life, Complexity, and the\par Causal Depth of Biological Systems (RACI):\par}
\vspace{0.4cm}
...
\vspace{0.3cm}
  {\small\textit{Preprint:}~\href{https://doi.org/10.5281/zenodo.19198224}
    {doi.org/10.5281/zenodo.19198224}\par}
\vspace{1.5cm}
...
RAHC~\citep{Sandeman2026RAHC}---the Assembly Index Correspondence, the DAG Markov
...
and (4)~the categorical impossibility of Boltzmann Brains. Four empirical
predictions follow, spanning astrobiology, origin-of-life chemistry, and
evolutionary biology. A new result: the Causal Firewall threshold
$\sigma = \lambda\tau_d\ell^3 = 1$ is proved (not merely conjectured)
...
\medskip\noindent
\textbf{Keywords:} Relational Actualism \textperiodcentered{} Causal Directed Acyclic Graph \textperiodcentered{} Assembly Theory \textperiodcentered{} Actualism Assembly Index \textperiodcentered{} Causal Firewall \textperiodcentered{} Erd\H{o}s-R\'{e}nyi Percolation \textperiodcentered{} Origin of Life \textperiodcentered{} Natural Selection \textperiodcentered{} Causal Assembly Depth \textperiodcentered{} Edge of Chaos \textperiodcentered{} Markov Blanket \textperiodcentered{} Quantum Darwinism \textperiodcentered{} Boltzmann Brain \textperiodcentered{} Density Functional Theory \textperiodcentered{} Poisson-CSG
...
parameters is developed in Section~\ref{sec:firewall-math}.
...
The framework makes four empirical predictions testable against observation and
...
\begin{itemize}
  ...
  $T_{\mathrm{env}}$ --- a measurable condition for any astrophysical environment.
...
\subsection{Prediction 4: The Categorical Impossibility of the Boltzmann Brain}
...
The four empirical predictions of Section~\ref{sec:predictions} follow from this
...
\begin{enumerate}[leftmargin=*]
  ...
  possible --- a constraint on origin-of-life models.
