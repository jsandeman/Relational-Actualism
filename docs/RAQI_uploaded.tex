...
Matter} (RATM)~\citep{Sandeman2026RATM} has now established, via 67 Lean-verified
...
Lean-QuantumInfo library~\citep{Meiburg2025LQI}. The RA suite now has
\textbf{93 Lean-verified results} (zero \texttt{sorry} tags) across
