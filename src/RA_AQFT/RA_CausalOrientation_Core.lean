...
theorem symmetric_branch_depth2_preserved_all (m : Fin 15) :
    extensionScore_sym_branch m ≤ 0 ∨ extensionScore_sym_branch m = bdgScore 1 2 0 0 := by
  have h := D1c_sym_branch_complete m
...
theorem asymmetric_branch_extensions_classified (m : Fin 15) :
    ...
    extensionScore_asym_branch m = 2 := D1c_asym_branch_complete m
