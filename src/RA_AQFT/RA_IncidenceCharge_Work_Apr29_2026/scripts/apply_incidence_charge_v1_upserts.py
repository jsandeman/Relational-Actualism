...
def main():
    ...
    patch=root/'registry_upserts_incidence_charge_v1'
    upsert(reg/'artifacts.csv', patch/'RAKB_incidence_charge_v1_artifacts_upsert_Apr29_2026.csv', lambda r:r.get('artifact_id',''), args.dry_run)
    upsert(reg/'claim_artifact_edges.csv', patch/'RAKB_incidence_charge_v1_claim_artifact_edges_upsert_Apr29_2026.csv', edge_key, args.dry_run)
    if not args.dry_run:
